...
The standalone version of [Laravel's Blade templating engine](https://laravel.com/docs/13.x/blade) for use outside of Laravel.
...
The Blade instance passes all methods to the internal view factory. So methods such as `exists`, `file`, `share`, `composer` and `creator` are available as well. Check out the [original documentation](https://laravel.com/docs/13.x/views) for more information.
